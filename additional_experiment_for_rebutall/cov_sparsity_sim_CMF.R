sim_func_cov_CMF <- function( N=2000, # number of row
  ...
  res  <- cmfrec::CMF(X=Y_obs , U= X_l, I=X_f)
  ...
  rmse_CMF         <- rmse(Y_true, t (res$matrices$A)%*%res$matrices$B)

...
if(file.exists("C:/Document/Serieux/Travail/Data_analysis_and_papers/cEBMF_RCC_experiments/additional_experiment_for_rebutall/tiling_results_mfair/tiling_2.RData" )){
...
for (o  in (length(res)+1):1000) {
  ...
  save(res, file="C:/Document/Serieux/Travail/Data_analysis_and_papers/cEBMF_RCC_experiments/additional_experiment_for_rebutall/tiling_results_mfair/tiling_2.RData")
}

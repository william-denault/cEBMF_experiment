...
ggsave( plot_grid(p11,p12,
                  ...
                  p41,p42                  ,
                  nrow = 4,ncol = 2),
        file= paste0("C:/Document/Serieux/Travail/Data_analysis_and_papers/cEBMF_RCC_experiments/additional_experiment_for_rebutall/mfair_spatial_transcriptomics_results/comp_MFAI_cEBMF10.pdf"),
        width =21  ,
        height =  29.7,
        units = "cm"
)

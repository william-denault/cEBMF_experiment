...
res<- cmfrec::CMF(X=tt0-min(tt0)+0.0001 , U= X_l,nonneg=TRUE,k=7 )
...
save(res,
     file=paste0("C:/Document/Serieux/Travail/Data_analysis_and_papers/cEBMF_RCC_experiments/additional_experiment_for_rebutall/CMF_spatial_transcriptomics_results/run_spatial_DLPFC_",i,".RData")
)

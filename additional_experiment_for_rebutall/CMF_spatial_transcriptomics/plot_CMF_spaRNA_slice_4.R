...
p6 <- plot_memberships_on_slice(m,loc,title = "CMF + clustering",
  ...
  ggsave( plot_grid(p11,p12,
                    ...
                    p41,p42                  ,
                    nrow = 4,ncol = 2),
          file= paste0("C:/Document/Serieux/Travail/Data_analysis_and_papers/cEBMF_RCC_experiments/additional_experiment_for_rebutall/CMF_spatial_transcriptomics_results/comp_CMF_cEBMF4.pdf"),
          width =21  ,
          height =  29.7,
          units = "cm"
  )

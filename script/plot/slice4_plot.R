...
# There are 12 different samples.
 ...
 i=4
  ...
  slice4_vae_embeddings <- read.csv("C:/Document/Serieux/Travail/python_work/cEBMF_additional_simulation_VAE/slice4_vae_embeddings.csv")
  spec_cluster <- kmeans(slice4_vae_embeddings,centers = clusterNum[i], nstart = 100)
  clusterlabel= as.numeric(walktrap_clustering(clusternum=clusterNum[i], t(slice4_vae_embeddings),knearest=70 ))
  ...
  slice4_cvae_embeddings <- read.csv("C:/Document/Serieux/Travail/python_work/cEBMF_additional_simulation_VAE/slice4_cvae_embeddings.csv")
  spec_cluster <- kmeans(slice4_cvae_embeddings,centers = clusterNum[i], nstart = 100)
  clusterlabel= as.numeric(walktrap_clustering(clusternum=clusterNum[i], t(slice4_vae_embeddings),knearest=70 ))
  ...
  slice4_ncf_embeddings <- read.csv("C:/Document/Serieux/Travail/python_work/cEBMF_additional_simulation_VAE/slice4_ncf_embeddings.csv")


  spec_cluster <- kmeans( slice4_ncf_embeddings,centers = clusterNum[i], nstart = 100)
  clusterlabel= as.numeric(walktrap_clustering(clusternum=clusterNum[i], t( slice4_ncf_embeddings),knearest=70 ))
  ...
  load("C:/Document/Serieux/Travail/Data_analysis_and_papers/cEBMF_submission/cEBMF_RCC_experiments/additional_experiment_for_rebutall/mfair_spatial_transcriptomics_results/run_spatial_DLPFC_4.RData")

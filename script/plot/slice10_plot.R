...
load( paste0( "C:/Document/Serieux/Travail/Data_analysis_and_papers/cEBMF_submission/cEBMF_RCC_experiments/data/DLPFC/LIBD_sample",i,".RData"))
load(paste0( "C:/Document/Serieux/Travail/Data_analysis_and_papers/cEBMF_submission/cEBMF_RCC_experiments/data/res_spatial_PCA/run_spatial_DLPFC",i,".RData"))
...
load(paste( "C:/Document/Serieux/Travail/Data_analysis_and_papers/cEBMF_submission/cEBMF_RCC_experiments/data/res_ebmf/fit_default_",i,".RData", sep=""))

load(paste( "C:/Document/Serieux/Travail/Data_analysis_and_papers/cEBMF_submission/cEBMF_RCC_experiments/data/res_nmf/fit_nmf_",i,".RData", sep=""))
...
load(paste( "C:/Document/Serieux/Travail/Data_analysis_and_papers/cEBMF_submission/cEBMF_RCC_experiments/data/res_cebmf/fit_cebmf_",i,".RData", sep=""))
...
p4 <- plot_memberships_on_slice(m,loc,title = "Spatial PCA ",
                                colors = c(factor_colors7  ))


slice10_vae_embeddings <- read.csv("C:/Document/Serieux/Travail/python_work/cEBMF_additional_simulation_VAE/slice10_vae_embeddings.csv")
spec_cluster <- kmeans(slice10_vae_embeddings,centers = clusterNum[i], nstart = 100)
clusterlabel= as.numeric(walktrap_clustering(clusternum=clusterNum[i], t(slice10_vae_embeddings),knearest=70 ))
...
p6 <- plot_memberships_on_slice(m,loc,title = "VAE ",
                                colors = c(factor_colors7  ))




slice10_cvae_embeddings <- read.csv("C:/Document/Serieux/Travail/python_work/cEBMF_additional_simulation_VAE/slice10_cvae_embeddings.csv")
spec_cluster <- kmeans(slice10_cvae_embeddings,centers = clusterNum[i], nstart = 100)
clusterlabel= as.numeric(walktrap_clustering(clusternum=clusterNum[i], t(slice10_vae_embeddings),knearest=70 ))
...
p7 <- plot_memberships_on_slice(m,loc,title = "cVAE ",
                                colors = c(factor_colors7  ))

slice10_ncf_embeddings <- read.csv("C:/Document/Serieux/Travail/python_work/cEBMF_additional_simulation_VAE/slice10_ncf_embeddings.csv")


spec_cluster <- kmeans( slice10_ncf_embeddings,centers = clusterNum[i], nstart = 100)
clusterlabel= as.numeric(walktrap_clustering(clusternum=clusterNum[i], t( slice10_ncf_embeddings),knearest=70 ))
...
p8 <- plot_memberships_on_slice(m,loc,title = "NCF ",
                                colors = c(factor_colors7  ))



load("C:/Document/Serieux/Travail/Data_analysis_and_papers/cEBMF_submission/cEBMF_RCC_experiments/additional_experiment_for_rebutall/mfair_spatial_transcriptomics_results/run_spatial_DLPFC_10.RData")
...
p9 <- plot_memberships_on_slice(m,loc,title = "MFAI",
                                colors = c(factor_colors7  ))

ggsave(  plot_grid(p1+theme(legend.position = "None"),
                   ...
                   p9+theme(legend.position = "None"),nrow = 1,ncol = 8),
        file= paste0("C:/Document/Serieux/Travail/Data_analysis_and_papers/Neurips2025_experiments/plot_slice_",i,".pdf"),
        width =29.7  ,
        height =  12,
        units = "cm"
)
ggsave(  plot_grid(p1+theme(legend.position = "None"),
                   ...
                   p8+theme(legend.position = "None"),
                   p3+theme(legend.position = "None"),
                   p9+theme(legend.position = "None"),nrow = 1,ncol = 8,scale=1.3),
         file= paste0("C:/Document/Serieux/Travail/Data_analysis_and_papers/Neurips2025_experiments/plot_slice_",i,"_deep.png"),
         width =29.7  ,
         height =  6,
         units = "cm"
)
